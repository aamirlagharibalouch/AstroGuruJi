...
<!--Slider Start-->
<div class="ast_slider_wrapper style_2 index_horoscope" style="background-image: url('images/banner/HorosocopeBanner.jpeg'); background-size: cover;">
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-lg-push-7 col-md-push-7 col-sm-push-0 col-xs-push-0">
				<div class="ast_about_info_img">
					<div class="about_slider">
						<div class="card c" id="first"><img src="images/banner/HorosocopePageImage.jpeg" alt="" class="img-responsive"></div>
						<div class="card a" id="second"><img src="images/banner/HorosocopePageImage2.jpeg" alt="" class="img-responsive"></div>
...
<!--Horoscope End-->
<!--Searchbox Start-->
<div class="ast_searchbox_wrapper horoscope_search ast_toppadder70 ast_bottompadder70" style="background-image: url('images/banner/Home-banner.jpeg'); background-size: cover;">
	<div class="container">
		<div class="row">
